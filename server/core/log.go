...
func registerFile(c config.LogConfig, backends []oplogging.Backend) []oplogging.Backend {
	if c.File != "" {
...
func createBackend(w io.Writer, c config.LogConfig, level oplogging.Level) oplogging.Backend {
